...
/**
 * Job: jpb_k Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20231017_1026-patch
 * @status 
 */
public class jpb_k implements TalendJob {
	static {System.setProperty("TalendJob.log", "jpb_k.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(jpb_k.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "jpb_k";
	private final String projectName = "K_DATALAKE";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_u1E-QPQNEe6cNbvfg5Z4cQ", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jpb_k.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_K_DATALAKE_jpb_k = new byte[0];
    static byte[] commonByteArray_K_DATALAKE_jpb_k = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_K_DATALAKE_jpb_k.length) {
				if(length < 1024 && commonByteArray_K_DATALAKE_jpb_k.length == 0) {
   					commonByteArray_K_DATALAKE_jpb_k = new byte[1024];
				} else {
   					commonByteArray_K_DATALAKE_jpb_k = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_K_DATALAKE_jpb_k, 0, length);
			strReturn = new String(commonByteArray_K_DATALAKE_jpb_k, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_K_DATALAKE_jpb_k, 0, length);
			strReturn = new String(commonByteArray_K_DATALAKE_jpb_k, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_K_DATALAKE_jpb_k) {
...
public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "xFvrWP_" + subJobPidCounter.getAndIncrement());
...
out1_tmp.newColumn = row1.newColumn ;
out1 = out1_tmp;
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "eHhR6d_" + subJobPidCounter.getAndIncrement());
 ...
 */
    ...
    public static void main(String[] args){
        final jpb_k jpb_kClass = new jpb_k();

        int exitCode = jpb_kClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'jpb_k' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'jpb_k' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_u1E-QPQNEe6cNbvfg5Z4cQ");
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-04-06T13:04:57.419062300Z");
        ...
        try {
            ...
            java.io.InputStream inContext = jpb_k.class.getClassLoader().getResourceAsStream("k_datalake/jpb_k_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = jpb_k.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'jpb_k' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jpb_k");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'jpb_k' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     71343 characters generated by Talend Cloud Data Management Platform 
 *     on the 6 April 2024 at 6:34:57 PM IST
 ************************************************************************************************/