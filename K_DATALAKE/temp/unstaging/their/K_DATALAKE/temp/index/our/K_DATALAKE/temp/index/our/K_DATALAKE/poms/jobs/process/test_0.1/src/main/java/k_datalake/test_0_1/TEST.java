...
public class TEST implements TalendJob {
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "2PPMOU_" + subJobPidCounter.getAndIncrement());
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "KGBGoq_" + subJobPidCounter.getAndIncrement());
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_GTYkQPJ4Ee6jvIvMN31qig");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-04-04T11:42:17.617717500Z");
		...
		try {
			...
			java.io.InputStream inContext = TEST.class.getClassLoader()
					.getResourceAsStream("k_datalake/test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 43430 characters generated by Talend Cloud Data Management Platform on the 4
 * April 2024 at 5:12:17 PM IST
 ************************************************************************************************/